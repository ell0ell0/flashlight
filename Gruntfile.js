module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      bodyScripts: {
        src: [
          ...
          'src/vendor/fj-*/*.js',
          'src/vendor/cf-*/*.js',
          'src/vendor/stellar/jquery.stellar.js',
    ...
    uglify: {
      ...
      // },
      bodyScripts: {
        src: ['src/static/js/main.js', 'src/vendor/respond/respond.src.js'],
        ...
        [
          {
            ...
            src: [
              ...
              // Exclude known source files in css/ and js/
              '!static/css/*.less',
              '!static/css/main.css',
              '!static/js/app.js',
    ...
    watch: {
      gruntfile: {
        files: ['Gruntfile.js', 'src/static/css/*.less', 'src/static/js/app.js', 'src/index.html'],
